              ...
              <div class="card-body">
                ...
                <form action="" enctype="multipart/form-data" method="post">
                  <div class="form-group">
                    ...
                    <input type="text" id="doc_name" class="form-control" name="doc_name" required="" value="<?=$document->document_name ?>" readonly="" />
                  </div>
                  <div class="form-group">
                    <label for="doc_file">Document</label>
                    <input type="file" id="input-file-now" class="dropify" name="doc_file" required="" data-default-file="<?=site_url('uploads/'.$document->document_file) ?>" />
                  </div>
                  <div class="form-group">
