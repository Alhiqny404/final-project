...
<head>
  ...
  <link href="<?=assets_dashboard() ?>plugins/jvectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet">
...
<body>
                  ...
                  <div class="row">
                    <div class="col-8 align-self-center">
                      <div class="">
                        ...
                        <p class="mb-0 text-muted">
                          <span class="text-success"><i class="mdi mdi-arrow-up"></i>14.5%</span> Up from yesterday
                        </p>
                      </div>
                    </div>
                    <!--end col-->
                          ...
                          <div class="col-12 align-self-center">
                            <div class="text-center">
                              ...
                              <p class="mb-1 text-muted">
                                <span class="text-success"><i class="mdi mdi-arrow-up"></i>35.5%</span> Last 100 Subscriptions
                              </p>
                            </div>
                          </div>
                          <!--end col-->
                        ...
                        <div class="row">
                          <div class="col-12 align-self-center">
                            <div class="text-center">
                              ...
                              <p class="mb-1 text-muted">
                                <span class="text-danger"><i class="mdi mdi-arrow-down"></i>1.5%</span> Down From Last week
                              </p>
                            </div>
                          </div>
                          <!--end col-->
                        ...
                        <div class="row">
                          <div class="col-12 align-self-center">
                            <div class="text-center">
                              ...
                              <p class="mb-1 text-muted">
                                <span class="text-success"><i class="mdi mdi-arrow-up"></i>11.1%</span> Up from Last Month
                              </p>
                            </div>
                          </div>
                          <!--end col-->
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="mt-2">
                        <img src="images/flags/us_flag.jpg" alt="" class="mb-2" height="30">
                      ...
                      <div class="row mt-4">
                        <div class="col-md-6">
                          <p class="mb-2 text-muted font-13">
                            Domestic Customers
                          </p>
                          <h3 class="mt-0"><img src="images/flags/us_flag.jpg" alt="" class="mr-2 thumb-xs rounded-circle">2.8k</h3>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <img class="" src="images/products/img-1.png" alt="user"> </td>
                          <td>
                            Beg
                          </td>
                          <td>
                            <img src="images/flags/us_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle">
                          </td>
                        ...
                        <tr>
                          <td>
                            <img class="" src="images/products/img-2.png" alt="user"> </td>
                          <td>
                            Watch
                          </td>
                          <td>
                            <img src="images/flags/french_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle">
                          </td>
                        ...
                        <tr>
                          <td>
                            <img class="" src="images/products/img-3.png" alt="user"> </td>
                          <td>
                            Headphone
                          </td>
                          <td>
                            <img src="images/flags/spain_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle">
                          </td>
                        ...
                        <tr>
                          <td>
                            <img class="" src="images/products/img-4.png" alt="user"> </td>
                          <td>
                            Purse
                          </td>
                          <td>
                            <img src="images/flags/russia_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle">
                          </td>
                        ...
                        <tr>
                          <td>
                            <img class="" src="images/products/img-5.png" alt="user"> </td>
                          <td>
                            Shoe
                          </td>
                          <td>
                            <img src="images/flags/italy_flag.jpg" alt="" class="img-flag thumb-xxs rounded-circle">
                          </td>
                        ...
                        <tr>
                          <td>
                            <img class="" src="images/products/img-6.png" alt="user"> </td>
                          <td>
                            Boll
                          </td>
                          <td>
              ...
              <div class="card overflow-hidden">
                <div class="card-body bg-gradient1">
                  <div class="">
                    ...
                    <p class="text-white mb-0 font-16">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <div class="text-center">
                          ...
                          <p class="font-12 text-muted">
                            <i class="fas fa-globe mr-2"></i>USA Dealer
                          </p>
                          <p class="mb-0 text-muted">
                      ...
                      <div class="carousel-item">
                        <div class="text-center">
                          ...
                          <p class="font-12 text-muted">
                            <i class="fas fa-globe mr-2"></i>Russia Dealer
                          </p>
                          <p class="mb-0 text-muted">
                            Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin.
                          </p>
                      ...
                      <div class="carousel-item">
                        <div class="text-center">
                          ...
                          <h5>Matt Rosales</h5>
                          <p class="font-12 text-muted">
                            <i class="fas fa-globe mr-2"></i>Spain Dealer
                          </p>
                          <p class="mb-0 text-muted">
                            Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin.
                          </p>
                ...
                <div class="card-body dash-info-carousel">
                  <div id="carousel_review" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <div class="media">
                          <img src="images/flags/us_flag.jpg" class="mr-2 thumb-xs rounded-circle" alt="...">
                          <div class="media-body align-self-center">
                            <h6 class="m-0">USA Store</h6>
                          </div>
                        </div>
                        <div class="text-center">
                          <p class="review-data mb-0">
                            4.8<span>/ 5.0</span>
                          </p>
                          <p class="px-4 py-1 bg-soft-success d-inline-block rounded">
                            Very Good
                          </p>
                      ...
                      <div class="carousel-item">
                        <div class="media">
                          <img src="images/flags/spain_flag.jpg" class="mr-2 thumb-xs rounded-circle" alt="...">
                          <div class="media-body align-self-center">
                      ...
                      <div class="carousel-item">
                        <div class="media">
                          <img src="images/flags/russia_flag.jpg" class="mr-2 thumb-xs rounded-circle" alt="...">
                          <div class="media-body align-self-center">
  ...
  <script src="<?=assets_dashboard() ?>plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
  <script src="<?=assets_dashboard() ?>plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

  <script src="<?=assets_dashboard() ?>plugins/moment/moment.js"></script>
  <script src="<?=assets_dashboard() ?>plugins/apexcharts/apexcharts.min.js"></script>
  <script src="https://apexcharts.com/samples/irregular-data-series.js"></script>
  <script src="https://apexcharts.com/samples/series1000.js"></script>
  <script src="https://apexcharts.com/samples/ohlc.js"></script>
  <script src="<?=assets_dashboard() ?>pages/jquery.dashboard.init.js"></script>
