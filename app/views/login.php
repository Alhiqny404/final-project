    ...
    <div class="col-lg-4">
      <div class="card mb-0 shadow-none">
        <div class="card-body">
          ...
          <div class="px-3">
            <div class="media">
              <a href="index.html" class="logo logo-admin"><img src="<?=assets_dashboard(); ?>images/logo-sm.png" height="55" alt="logo" class="my-3"></a>
              <div class="media-body ml-3 align-self-center">
                <h4 class="mt-0 mb-1">Login</h4>
                <p class="text-muted mb-0">
                  belum tahu mau dikasih bacaan apa:v
                </p>
              </div>
            </div>
            ...
            <form class="form-horizontal my-4" action="" method="post">
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" id="username" name="username" placeholder="Enter username" required autofocus="1">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="password" class="form-control" id="userpassword" name="password" placeholder="Enter password" required autofocus="2">
                </div>
              </div>
