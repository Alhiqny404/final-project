...
<body>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="page-title-box">
            ...
            <h4 class="page-title mb-2"><i class="mdi mdi-cloud-upload-outline mr-2"></i>File Uploads</h4>
            <div class="">
              <ol class="breadcrumb">
            ...
            <div class="col-xl-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <input type="file" id="input-file-now-custom-3" class="dropify" data-height="500" data-default-file="plugins/dropify/images/2.jpg" />
                </div>
                <!--end card-body-->
              </div>
              <!--end card-->
  ...
  <script src="<?=assets_dashboard(); ?>pages/jquery.form-upload.init.js"></script>
