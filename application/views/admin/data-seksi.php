<?php
// Prefix halaman ini
$prefix_page = 'admin/kelola/seksi/';
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('.tambah-data').on('click', function(e) {
      ...
      $('.custom-modal-title').html('Tambah Data Seksi');
    ...
    $('.edit-table').on('click', function(e) {
      ...
      $('.custom-modal-title').html('Edit Data Seksi');
      $('#form').attr('action', url)
      $('[name=id]').val(id)
      $('[name=nama_seksi]').val(nama)
      ...
      <div class="col">
        <form class="form" id="form" action="" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" required placeholder="Isi nama seksi" name="nama_seksi" />
          </div>
          <div class="form-group">
            <label>Warna</label>
