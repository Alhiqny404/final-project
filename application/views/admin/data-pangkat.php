<?php
// Prefix halaman ini
$prefix_page = 'admin/kelola/pangkat/';
              ...
              <div class="card-body table-responsive">
                ...
                <div class="">
                  <table id="datatable" class="table dt-responsive table-hover nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                      <?php $no = 1; foreach ($pangkat as $val): ?>
                      <tr>
                        <td><?=$no++ ?></td>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('.tambah-data').on('click', function(e) {
      ...
      $('.custom-modal-title').html('Tambah Data Pangkat');
    ...
    $('.edit-table').on('click', function(e) {
      ...
      $('.custom-modal-title').html('Edit Data Pangkat');
      $('#form').attr('action', url)
      $('[name=id]').val(id)
      $('[name=nama_pangkat]').val(nama)
      modalku('#custom-modal', 'fadein');
    })
      ...
      <div class="col">
        <form class="form" id="form" action="" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" required placeholder="Isi nama pangkat" name="nama_pangkat" />
          </div>
