...
<div class="left-sidenav">
  ...
  <ul class="metismenu left-sidenav-menu" id="side-nav">
    ...
    <li>
      <a href="<?=site_url($prefix_viewer.'management') ?>" class="text-decoration-none"><i class="mdi mdi-monitor"></i><span>Management</span></a>
    </li>
    <li>
    ...
    <li>
      <a href="<?=site_url($prefix_admin.'management') ?>" class="text-decoration-none"><i class="mdi mdi-monitor"></i><span>Management</span></a>
    </li>
    <li>
    ...
    <li>
      <a href="<?=site_url($prefix_supervisor.'management') ?>" class="text-decoration-none"><i class="mdi mdi-monitor"></i><span>Management</span></a>
    </li>
    ...
    <li>
      <a href="<?=site_url($prefix_user.'management') ?>" class="text-decoration-none"><i class="mdi mdi-monitor"></i><span>Management</span></a>
    </li>
    <li>
