...
*/
class Laporan_sebelumnya_model extends CI_Model {
  ...
  * @var	string
  */
  private $table = 'laporan_sebelumnya';
  ...
  */
  public function getAll() {
    $this->db->select('user.nama_lengkap,jenis_laporan.nama_laporan,laporan_sebelumnya.*');
    $this->db->from($this->table);
    $this->db->join('user', 'user.id = laporan_sebelumnya.user_id', 'left outher');
    $this->db->join('jenis_laporan', 'jenis_laporan.id = laporan_sebelumnya.jenis_laporan_id', 'left outher');
  ...
  */
  public function getMe() {
    $this->db->select('jenis_laporan.nama_laporan,laporan_sebelumnya.*');
    $this->db->from($this->table);
    $this->db->join('jenis_laporan', 'jenis_laporan.id = laporan_sebelumnya.jenis_laporan_id', 'left outher');
  ...
  */
  public function edit() {
    ...
    $LaporanLama = $this->db->select('status')->from('laporan_sebelumnya')->where('id', $dataForm['id'])->get()->row();
